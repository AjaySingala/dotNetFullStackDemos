...
namespace PredictiveMaintenanceModel_ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\ajay.singala\Docs\dotNetFullStackDemos\ML.NET\MyMLApp\ai4i2020\ai4i2020.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"Type", @"Type", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=5,NumberOfLeaves=5,FeatureFraction=0.9102374F,LabelColumnName=@"Machine failure",FeatureColumnName=@"Features"}),labelColumnName:@"Machine failure"))      
